...
class Notificacion extends Model
{
    ...
    protected $allowIncluded = ['notificaciones', 'users']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'nombre', 'aspectos_claves'];

    protected $allowSort = ['id', 'nombre', 'aspectos_claves'];
